...
public class DatosFarmacoCrearDTO {
    ...
    /** Nombre del fármaco */
    @JsonProperty("nombre")
    @NotBlank(message = "El parámetro 'nombre' no puede ir vacío.", groups=Crear.class )
    @NotNull(message = "El parámetro 'nombre' es obligatorio.", groups=Crear.class )
    ...
    @Valid
    @NotNull(message = "El parámetro 'propiedades' es obligatorio.", groups=Crear.class )
