 ...
 * a bottom sheet.
 */
public class TopSheetDialog<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public TopSheetDialog(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * A utility function to get the {@link TopSheetDialog} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link TopSheetDialog}.
     * @return The {@link TopSheetDialog} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> TopSheetDialog<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof TopSheetDialog)) {
            throw new IllegalArgumentException("The view is not associated with TopSheetBehavior");
        }
        return (TopSheetDialog<V>) behavior;
    }
